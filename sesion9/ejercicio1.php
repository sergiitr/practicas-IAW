    ...
    <body>
        ...
        <?php
            ...
            if (mysqli_connect_errno()) {
                ...
                $consulta = "select CodArt,articulos.Descripcion,PrecioCompra,PVP,FechaCompra,Stock,proveedores.descripcion as descrip from articulos,proveedores where proveedores.codigo=articulos.proveedor";
        ...
        ?>
        <p>Para ver el fichero pulse <a href="./ejercicio1.txt">aqui</a></p>
    </body>
</html>