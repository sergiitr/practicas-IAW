...
<html lang="es">
    ...
    <body>
        <h1>Practica 7 - Curriculum Vitae</h1>
            ...
            <fieldset>
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td id="param"><input type="number" id="telefono" name="telefono" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="param"><input name='f_titulacion' type="number" minlength="4" maxlength="4" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="param"><input name='capacidades' type="text"></td>
                    </tr>
                    <tr>
                        <td id="noparam"><p>URL personal </p></td>
                        <td id="param"><input name='url' type="text"></td>
                    </tr>
                    <tr>
